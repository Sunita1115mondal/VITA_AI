...
import { MessageCircle, X, Send, Search, Loader2, Sparkles, User, Bot, ExternalLink } from 'lucide-react';
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      role: 'model',
      content: 'Hello! I am VITA-AI Assistant. Ask me anything about your health, fitness trends, or how to use the app.'
    }
  ]);
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
          ...
          <div className="p-3 bg-white border-t border-slate-200">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder={useSearch ? "Ask with Google Search..." : "Ask VITA-AI..."}
      ...
      <button
        ...
        className={`w-14 h-14 rounded-full shadow-lg shadow-blue-200 flex items-center justify-center transition-all hover:scale-105 active:scale-95 ${
          isOpen ? 'bg-slate-800 text-white' : 'bg-gradient-to-r from-blue-600 to-teal-500 text-white'
        }`}
      >
